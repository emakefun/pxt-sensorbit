...
- [智能模块](#jump_5)
    - [语音识别模块](#jump_5_1-语音识别模块)

## 基础输入模块<a id="jump_1"></a>
### 1. 矩阵键盘模块<a id="jump_1_1"></a>
- 初始化矩阵键盘引脚SCL,SDO  
...
- 显示测量出的距离值
### 20.  DHT11温湿度传感器<a id="jump_2_20"></a>
- 通过引脚获得环境湿度或温度的值
