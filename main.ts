...
namespace sensors {
    ...
    */
    ...
    export class DS1302RTC {
         ...
         * get Year
         */
        //% blockId="DS1302_get_year" block="%ds|get year"  group="触摸键盘"
         ...
         */
        //% blockId="DS1302_set_year" block="%ds|set year %dat"  group="触摸键盘"
         ...
         * get Month
         */
        //% blockId="DS1302_get_month" block="%ds|get month"  group="DS1302"
         ...
         */
        //% blockId="DS1302_set_month" block="%ds|set month %dat" group="DS1302"
        //% subcategory="执行器"
         ...
         * get Day
         */
        //% blockId="DS1302_get_day" block="%ds|get day" group="DS1302"
        //% subcategory="执行器"
         ...
         */
        //% blockId="DS1302_set_day" block="%ds|set day %dat" group="DS1302"
        //% subcategory="执行器"
         ...
         * get Week Day
         */
        //% blockId="DS1302_get_weekday" block="%ds|get weekday" group="DS1302"
        //% subcategory="执行器"
         ...
         */
        //% blockId="DS1302_set_weekday" block="%ds|set weekday %dat" group="DS1302"
        //% subcategory="执行器"
         ...
         * get Hour
         */
        //% blockId="DS1302_get_hour" block="%ds|get hour" group="DS1302"
        //% subcategory="执行器"
         ...
         */
        //% blockId="DS1302_set_hour" block="%ds|set hour %dat" group="DS1302"
        //% subcategory="执行器"
         ...
         * get Minute
         */
        //% blockId="DS1302_get_minute" block="%ds|get minute" group="DS1302"
        //% subcategory="执行器"
        //% weight=72 blockGap=8
        getMinute(): number {
         ...
         */
        //% blockId="DS1302_set_minute" block="%ds|set minute %dat" group="DS1302"
        //% subcategory="执行器"
         ...
         * get Second
         */
        //% blockId="DS1302_get_second" block="%ds|get second" group="DS1302"
        //% subcategory="执行器"
         ...
         */
        //% blockId="DS1302_set_second" block="%ds|set second %dat" group="DS1302"
        //% subcategory="执行器"
         ...
         */
        //% blockId="DS1302_set_DateTime" block="%ds|set Date and Time: Year %year|Month %month|Day %day|WeekDay %weekday|Hour %hour|Minute %minute|Second %second" group="DS1302"
        //% subcategory="执行器"
         ...
         */
        //% blockId="DS1302_start" block="%ds|start RTC" group="DS1302"
        //% subcategory="执行器"
         ...
         * pause ds1302 RTC
         */
        //% blockId="DS1302_pause" block="%ds|pause RTC" group="DS1302"
        //% subcategory="执行器"
         ...
         * read RAM
         */
        //% blockId="DS1302_read_ram" block="%ds|read ram %reg" group="DS1302"
        //% subcategory="执行器"
         ...
         * write RAM
         */
        //% blockId="DS1302_write_ram" block="%ds|write ram %reg|with %dat" group="DS1302"
        //% subcategory="执行器"
    ...
    //% blockId="DS1302_create" block="CLK %clk|DIO %dio|CS %cs" group="DS1302"
    //% subcategory="执行器"
